...
s.parentNode.insertBefore(t,s)}(window, document,'script',
        ...
        fbq('init', '2074997526279058');
        fbq('track', 'PageView');
        `}
      </Script>
      <noscript>
        <img height="1" width="1" src="https://www.facebook.com/tr?id=2074997526279058&ev=PageView&noscript=1" />
      </noscript>
      {/* <!-- Google tag (gtag.js) --> */}
      ...
      <div className="body">
        ...
        <div className="wrapper wrapper-out">
          <form className="form-gap" method='POST' onSubmit={handleSubmit}>
            ...
            <div className="input-box">
              ...
              <button onClick={sendOTP} disabled={timer > 0}>
                <p>Send OTP <i class="fa-solid fa-circle-arrow-right"></i></p>
              </button>
            </div>
            ...
            <Link href="https://wa.me/918302401270?text=Hello%20I%20Need%20!D">
